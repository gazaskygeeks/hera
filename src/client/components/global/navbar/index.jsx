      ...
      <div className="navbar">
        <ul className="navbar__list">
          <li className="navbar__list__logo">
            <img src="/assets/hera.png" alt="hera-logo" style={{ width:'80px' }}/></li>
          <a className='nav_anchor navbar__list__item' href='/'><li className="navbar__list__item">Home</li></a>
          <a className='nav_anchor navbar__list__item' href='/tools'><li className="navbar__list__item">Tools</li></a>
          ...
          <li className="navbar__list__item">
            <span style={{ width:'48px' }}>{this.state.language}
